...
const NXSWB1Layout = (props) => {

    const locksMapping = {
        allLocks: lockers.NXSWB1,
        seatNoA: ["S1","S6", "S11", "S15"],
        seatNoB: ["S2","S7", "QR", "S16"],
        seatNoC: ["S3", "S8", "S12", "S17"],
        seatNoD: ["S4", "S9","S13", "S18"],
        seatNoE: ["M5", "M10", "M14", "M19"],
      };
