...
const FMCALIGFlayout = (props) => {
    const locksMapping = {
        allLocks: lockers.FMCALIGF,
        seatNoA: ["S1", "QR", "M2", "M3"],
        seatNoB: ["L4", "L5", "L6", "L7", "L8"],
      };
      ...
      return (
        <div className="grid-container">
          <div className="layout-table-container-fmcaligf">
