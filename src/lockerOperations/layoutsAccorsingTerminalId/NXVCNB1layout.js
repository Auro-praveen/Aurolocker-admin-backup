...
const NXVCNB1layout = (props) => {


    const locksMapping = {
        allLocks: lockers.NXVCNB1,
        seatNoA: ["S1", "S5", "S9", "S13"],
        seatNoB: ["S2", "QR", "S10", "S14"],
        seatNoC: ["M3", "S6", "M11" , "M15"],
        seatNoD: ["S7"],
        seatNoE: ["M4", "M8", "M12", "M16"],
      };
