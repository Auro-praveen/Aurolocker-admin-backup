...
const HLCALIGFlayout = (props) => {
    const locksMapping = {
        allLocks: lockers.HLCALIGF,
    
        seatNoA: ["S1", "S4", "L7", "L11"],
        seatNoB: ["QR", "L8", "L12"],
        seatNoC: ["M2", "M5",  "L9", "L13"],
        seatNoD: ["XL10", "XL14"],
        seatNoE: ["M3", "M6"],
      };
      ...
      return (
        <>
          <div className="layout-container-hlcaligf">
