...
const MOAWEST2layout = (props) => {
  const locksMapping = {
    allLocks: lockers.MOAWEST2,
    seatNoA: ["L1", "QR", "L2", "XL3"],
    seatNoB: ["L4", "L5", "L6", "XL7"],
  };
              ...
              <button
                className={`${
                  row.includes("S")
                    ...
                    : row.includes("M")
                    ? "medium-locks"
                    : row.includes("L") || row.includes("QR")
                    ? "large-locks"
                    : null
                }
                              ${"locker-common-des"}
