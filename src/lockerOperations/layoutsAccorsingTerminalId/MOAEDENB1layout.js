...
const MOAEDENB1layout = (props) => {
  const locksMapping = {
    allLocks: lockers.MOAEDENB1,
    seatNoA: ["S1", "S6", "S10", "S14"],
    seatNoB: ["S2", "S7", "QR", "S15"],
    seatNoC: ["S3", "M8", "S11", "M16"],
    seatNoD: ["S4", "S12"],
    seatNoE: ["M5", "M9", "M13", "M17"],
    // seatNoF: ["S6"],
  };
  ...
  return (
    <div>
      <div className="layout-container" style={{ width: "400px" }}>
        <table
          className="table table-responsive grid"
...
export default MOAEDENB1layout;
