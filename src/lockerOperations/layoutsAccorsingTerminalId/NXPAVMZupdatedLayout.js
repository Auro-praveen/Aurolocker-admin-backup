...
const NXPAVMZupdatedLayout = (props) => {
    const locksMapping = {
        allLocks: lockers.NXPAVMZupdate,
    
        seatNoA: ["S1", "S5", "L9", "L13"],
        seatNoB: ["QR", "S6", "L10", "L14"],
        seatNoC: ["S2", "M7", "L11", "L15"],
        seatNoD: ["S3","XL12", "XL16"],
        seatNoE: ["M4", "M8"]
      ...
      return (
        <>
          <div className="layout-container-pmccngf">
...
export default NXPAVMZupdatedLayout;